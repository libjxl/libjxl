...
#if !defined(JXL_PARALLEL_RUNNER_H_) || defined(CUSTOM_GENERATOR)
...
#	else
	ESCAPE(#ifndef JXL_PARALLEL_RUNNER_H_)
	ESCAPE(#define JXL_PARALLEL_RUNNER_H_)
...
EXTERN_C(
	 ...
	 * JxlParallelRunner().
	 */
	Delegate(JxlParallelRetCode, JxlParallelRunInit, (void* jpegxl_opaque, size_t num_threads))
	 ...
	 * JxlParallelRunInit.
	 */
	Delegate(void, JxlParallelRunFunction, (void* jpegxl_opaque, uint32_t value, size_t thread_id))
	 ...
	 */
	Delegate(JxlParallelRetCode, JxlParallelRunner,
		(
			void* runner_opaque,
			void* jpegxl_opaque,
