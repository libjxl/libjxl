...
#if !defined(JXL_DECODE_H_) || defined(CUSTOM_GENERATOR)
...
#   else
        ESCAPE(#ifndef JXL_DECODE_H_)
        ESCAPE(#define JXL_DECODE_H_)
        ESCAPE(#include <stddef.h>)
        ESCAPE(#include <stdint.h>)

        ESCAPE(#include "jxl/cms_interface.h")
...
EXTERN_C(
     ...
     */
    Export Method(JxlSignature, JxlSignatureCheck, (const uint8_t* buf, size_t len))
     ...
     */
    TypeDef(JxlDecoder, struct JxlDecoderStruct)
     ...
     */
    Export Method(JxlDecoder*, JxlDecoderCreate, (const JxlMemoryManager* memory_manager))
     ...
     */
    Export Method(void, JxlDecoderReset, (JxlDecoder* dec))
     ...
     */
    Export Method(void, JxlDecoderDestroy, (JxlDecoder* dec))
    ...
    EnumDef(JxlDecoderStatus,
         ...
         * unprocessed bytes.
         */
        DefinedValue(JXL_DEC_NEED_MORE_INPUT, 2)
         ...
         */
        DefinedValue(JXL_DEC_NEED_PREVIEW_OUT_BUFFER, 3)
         ...
         */
        DefinedValue(JXL_DEC_NEED_DC_OUT_BUFFER, 4)
         ...
         */
        DefinedValue(JXL_DEC_NEED_IMAGE_OUT_BUFFER, 5)
         ...
         */
        DefinedValue(JXL_DEC_JPEG_NEED_MORE_OUTPUT, 6)
         ...
         */
        DefinedValue(JXL_DEC_BOX_NEED_MORE_OUTPUT, 7)
         ...
         */
        DefinedValue(JXL_DEC_BASIC_INFO, 0x40)
         ...
         */
        DefinedValue(JXL_DEC_EXTENSIONS, 0x80)
         ...
         * data.
         */
        DefinedValue(JXL_DEC_COLOR_ENCODING, 0x100)
         ...
         */
        DefinedValue(JXL_DEC_PREVIEW_IMAGE, 0x200)
         ...
         * frames.
         */
        DefinedValue(JXL_DEC_FRAME, 0x400)
         ...
         * rendering, JxlDecoderFlushImage should be used.
         */
        DefinedValue(JXL_DEC_DC_IMAGE, 0x800)
         ...
         * JXL_DEC_DC_IMAGE.
         */
        DefinedValue(JXL_DEC_FULL_IMAGE, 0x1000)
         ...
         */
        DefinedValue(JXL_DEC_JPEG_RECONSTRUCTION, 0x2000)
         ...
         * "jumb" respectively.
         */
        DefinedValue(JXL_DEC_BOX, 0x4000)
         ...
         * or DC encoded.
         */
        DefinedValue(JXL_DEC_FRAME_PROGRESSION, 0x8000)
     )
     ...
     */
    Export Method(void, JxlDecoderRewind, (JxlDecoder* dec))
     ...
     */
    Export Method(void, JxlDecoderSkipFrames, (JxlDecoder* dec, size_t amount))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderDefaultPixelFormat, (const JxlDecoder* dec, JxlPixelFormat* format))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetParallelRunner, (JxlDecoder* dec, JxlParallelRunner parallel_runner, void* parallel_runner_opaque))
     ...
     */
    Export Method(size_t, JxlDecoderSizeHintBasicInfo, (const JxlDecoder* dec))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSubscribeEvents, (JxlDecoder* dec, int events_wanted))
     ...
     * @return JXL_DEC_SUCCESS if no error, JXL_DEC_ERROR otherwise.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetKeepOrientation, (JxlDecoder* dec, JXL_BOOL skip_reorientation))
     ...
     * @return JXL_DEC_SUCCESS if no error, JXL_DEC_ERROR otherwise.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetRenderSpotcolors, (JxlDecoder* dec, JXL_BOOL render_spotcolors))
     ...
     * @return JXL_DEC_SUCCESS if no error, JXL_DEC_ERROR otherwise.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetCoalescing, (JxlDecoder* dec, JXL_BOOL coalescing))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderProcessInput, (JxlDecoder* dec))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetInput, (JxlDecoder* dec, const uint8_t* data, size_t size))
     ...
     * file are.
     */
    Export Method(size_t, JxlDecoderReleaseInput, (JxlDecoder* dec))
     ...
     * @param dec decoder object
     */
    Export Method(void, JxlDecoderCloseInput, (JxlDecoder* dec))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetBasicInfo, (const JxlDecoder* dec, JxlBasicInfo* info))
     ...
     *    of other error conditions.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetExtraChannelInfo, (const JxlDecoder* dec, size_t index, JxlExtraChannelInfo* info))
     ...
     *    of other error conditions.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetExtraChannelName,
            (
     ...
     */
    EnumDef(JxlColorProfileTarget,
        /** Get the color profile of the original image from the metadata..
         */
        DefinedValue(JXL_COLOR_PROFILE_TARGET_ORIGINAL, 0)

        /** Get the color profile of the pixel data the decoder outputs. */
        DefinedValue(JXL_COLOR_PROFILE_TARGET_DATA, 1)
    )
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetColorAsEncodedProfile,
        (
     ...
     *    cannot be generated.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetICCProfileSize,
        (
            const JxlDecoder* dec, const JxlPixelFormat* format,
     ...
     *    large enough.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetColorAsICCProfile,
        (
            const JxlDecoder* dec, const JxlPixelFormat* format,
     ...
     *    otherwise.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetPreferredColorProfile, (JxlDecoder* dec, const JxlColorEncoding* color_encoding))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderPreviewOutBufferSize,(const JxlDecoder* dec, const JxlPixelFormat* format, size_t* size))
     ...
     * size too small.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetPreviewOutBuffer,(JxlDecoder* dec, const JxlPixelFormat* format, void* buffer, size_t size))
     ...
     *    of other error conditions.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetFrameHeader,(const JxlDecoder* dec, JxlFrameHeader* header))
     ...
     *    of other error conditions.
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetFrameName,(const JxlDecoder* dec, char* name, size_t size))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetExtraChannelBlendInfo, (const JxlDecoder* dec, size_t index, JxlBlendInfo* blend_info))
     ...
     */
    DEPRECATED Export Method(JxlDecoderStatus, JxlDecoderDCOutBufferSize, (const JxlDecoder* dec, const JxlPixelFormat* format, size_t* size))
     ...
     * JxlDecoderFlushImage for progressive rendering.
     */
    DEPRECATED Export Method(JxlDecoderStatus, JxlDecoderSetDCOutBuffer, (JxlDecoder* dec, const JxlPixelFormat* format, void* buffer, size_t size))
     ...
     *    information not available yet.
     */
    Export Method(JxlDecoderStatus, JxlDecoderImageOutBufferSize, (const JxlDecoder* dec, const JxlPixelFormat* format, size_t* size))
     ...
     * size too small.
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetImageOutBuffer, (JxlDecoder* dec, const JxlPixelFormat* format, void* buffer, size_t size))
     ...
     */
    Delegate(void, JxlImageOutCallback, (void* opaque, size_t x, size_t y, size_t num_pixels, const void* pixels))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetImageOutCallback,
        (
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderExtraChannelBufferSize,
        (
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetExtraChannelBuffer,
        (
            JxlDecoder* dec, const JxlPixelFormat* format,
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetJPEGBuffer,
        (
            JxlDecoder* dec,
     ...
     */
    Export Method(size_t, JxlDecoderReleaseJPEGBuffer, (JxlDecoder* dec))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetBoxBuffer,(JxlDecoder* dec, uint8_t* data, size_t size))
     ...
     */
    Export Method(size_t, JxlDecoderReleaseBoxBuffer,(JxlDecoder* dec))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderSetDecompressBoxes,(JxlDecoder* dec, JXL_BOOL decompress))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetBoxType,
		(
			JxlDecoder* dec,
			JxlBoxType type,
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderGetBoxSizeRaw, (const JxlDecoder* dec, uint64_t* size))
     ...
     */
    Export Method(void, JxlDecoderSetProgressiveDetail, (JxlDecoder* dec, uint32_t detail))
     ...
     */
    Export Method(JxlDecoderStatus, JxlDecoderFlushImage, (JxlDecoder* dec))
