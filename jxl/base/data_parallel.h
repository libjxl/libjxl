...
#ifndef JXL_BASE_DATA_PARALLEL_H_
#define JXL_BASE_DATA_PARALLEL_H_
...
#include "include/jpegxl/parallel_runner.h"
...
class ThreadPool {
 public:
  ...
  ThreadPool(JpegxlParallelRunner runner, void* runner_opaque)
 ...
 private:
  ...
  class RunCallState final {
   public:
    ...
    // JpegxlParallelRunInit interface.
    ...
    // JpegxlParallelRunFunction interface.
  ...
  // Default JpegxlParallelRunner used when no runner is provided by the
  // caller. This runner doesn't use any threading and thread_id is always 0.
  static JpegxlParallelRetCode SequentialRunnerStatic(
  ...
  const JpegxlParallelRunner runner_;
...
#endif  // JXL_BASE_DATA_PARALLEL_H_
