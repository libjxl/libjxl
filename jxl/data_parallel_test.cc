...
class DataParallelTest : public ::testing::Test {
 protected:
  ...
  static int FakeRunner(void* runner_opaque, void* jpegxl_opaque,
                        ...
                        JpegxlParallelRunFunction func, uint32_t start_range,
                        uint32_t end_range) {
  ...
  JpegxlParallelRunInit init_ = nullptr;
  JpegxlParallelRunFunction func_ = nullptr;
...
typedef int (*JpegxlParallelRunInit)();
